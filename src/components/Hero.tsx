    ...
    <section className="relative min-h-screen flex items-center justify-center hero-bg overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Text Content */}
          <div className="lg:text-left animate-fade-in max-w-xl mx-auto px-4">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-playfair font-bold mb-6 leading-snug break-words">
            ...
            <p className="text-base sm:text-xl md:text-2xl text-muted-foreground mb-8 font-inter font-light">
